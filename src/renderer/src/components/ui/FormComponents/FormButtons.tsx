...
export function FormButton({
  ...
  return (
    <HButton
      ...
      className={clsx(
        "flex items-center justify-center gap-2 rounded-sm overflow-hidden border border-zinc-400/5 bg-zinc-950/80 enabled:shadow-sm enabled:shadow-zinc-950/50 enabled:hover:shadow-none enabled:cursor-pointer disabled:opacity-50",
...
export function FormLinkButton({
  ...
  return (
    <Link
      ...
      title={title}
      className={clsx(
        "flex items-center justify-center gap-2 rounded-sm overflow-hidden border border-zinc-400/5 bg-zinc-950/80 shadow-sm shadow-zinc-950/50 hover:shadow-none cursor-pointer",
        type && COLOR_BY_TYPE[type],
        className
      )}
    >
