  ...
  return (
    <motion.li ref={ref} variants={GRIDITEM_VARIANTS} onClick={onClick} className={clsx("grow shrink-0", size)}>
      <motion.div
        ...
        exit="exit"
        className={clsx(
          "w-full h-full rounded-sm backdrop-blur-md border cursor-pointer shadow-sm shadow-zinc-950/50 hover:shadow-none duration-200",
          selected ? "bg-vs/15 border-vs/25" : "bg-zinc-950/80 border-zinc-400/5",
