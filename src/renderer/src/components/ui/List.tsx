...
export function ListItem({ children, className, onClick }: { children: React.ReactNode; className?: string; onClick?: () => void }): JSX.Element {
  return (
    <motion.li
      ...
      onClick={onClick}
      className={clsx(
        "w-full rounded-sm backdrop-blur-md bg-zinc-950/80 border border-zinc-400/5 group overflow-hidden shadow-sm shadow-zinc-950/50 hover:shadow-none duration-200",
