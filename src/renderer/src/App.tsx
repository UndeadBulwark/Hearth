...
import DownloadsPage from "./features/tasks/pages/DownloadsPage"
        ...
        <TaskProvider>
          <Router>
            <GlobalActionsWrapper>
              ...
              >
                <div className="w-full h-full flex bg-zinc-950/80">
                  <Loader />
      ...
      {!minTimeElapsed && (
        ...
        >
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="w-full h-full flex flex-col gap-4 items-center justify-center bg-zinc-950/80 backdrop-blur-md"
          >
