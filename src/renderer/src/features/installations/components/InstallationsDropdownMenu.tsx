  ...
  return (
    <div className="w-full">
      {config.installations.length < 1 ? (
        <div className="w-full flex flex-col items-center justify-between rounded-sm backdrop-blur-md bg-zinc-950/80 border border-zinc-400/5 group overflow-hidden shadow-sm shadow-zinc-950/50 px-4 py-2 text-center">
            ...
            <>
              {config.installations
                ...
                .map((current) => (
                  <ListboxButton
                    key={current.id}
                    className="w-full h-14 p-1 pr-2 flex items-center justify-between gap-2 rounded-sm overflow-hidden border border-zinc-400/5 bg-zinc-950/80 shadow-sm shadow-zinc-950/50 hover:shadow-none text-sm text-start cursor-pointer"
                  >
                    <img
                      src={
