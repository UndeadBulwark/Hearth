              ...
              <FormGroupWrapper title={t("generic.basics")}>
                <FromGroup>
                  ...
                  >
                    {({ open }) => (
                      <>
                        <ListboxButton className="w-1/3 h-13 p-1 pr-2 flex items-center justify-between gap-2 rounded-sm overflow-hidden border border-zinc-400/5 bg-zinc-950/80 shadow-sm shadow-zinc-950/50 hover:shadow-none text-sm text-start cursor-pointer">
