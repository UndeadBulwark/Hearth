...
export enum CONFIG_ACTIONS {
  ...
  SET_HIDE_LAUNCHER_WHILE_PLAYING = "SET_HIDE_LAUNCHER_WHILE_PLAYING",
  SET_SHOW_LAUNCHER_WHEN_GAME_STOPS = "SET_SHOW_LAUNCHER_WHEN_GAME_STOPS"
}
...
export interface SetMinimizeToTray {
  type: CONFIG_ACTIONS.SET_MINIMIZE_TO_TRAY
  payload: boolean
}

export interface SetHideLauncherWhilePlaying {
  type: CONFIG_ACTIONS.SET_HIDE_LAUNCHER_WHILE_PLAYING
  payload: boolean
}

export interface SetShowLauncherWhenGameStops {
  type: CONFIG_ACTIONS.SET_SHOW_LAUNCHER_WHEN_GAME_STOPS
  payload: boolean
}
...
export type ConfigAction =
  ...
  | RemoveFavMod
  | SetMinimizeToTray
  | SetHideLauncherWhilePlaying
  | SetShowLauncherWhenGameStops
...
const configReducer = (config: ConfigType, action: ConfigAction): ConfigType => {
  switch (action.type) {
    ...
    case CONFIG_ACTIONS.SET_MINIMIZE_TO_TRAY:
      return { ...config, minimizeToTray: action.payload }
    case CONFIG_ACTIONS.SET_HIDE_LAUNCHER_WHILE_PLAYING:
      return { ...config, hideLauncherWhilePlaying: action.payload }
    case CONFIG_ACTIONS.SET_SHOW_LAUNCHER_WHEN_GAME_STOPS:
      return { ...config, showLauncherWhenGameStops: action.payload }
    default:
      return config
  }
}
